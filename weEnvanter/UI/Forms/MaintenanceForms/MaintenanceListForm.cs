...
namespace weEnvanter.UI.Forms.MaintenanceForms
{
    public partial class MaintenanceListForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public MaintenanceListForm()
        {
            ...
            pLinqServerModeSource1.Source = new weEnvanter.Data.WeEnvanterDbContext().MaintenanceRecords;
        ...
        private void btn_AddNewMaintenance_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                using (var addMaintenanceForm = new AddOrEditMaintenanceForm(_maintenanceService, OperationType.Add))
                {
        ...
        {
            var selectedRow = gridView_Maintenances.GetFocusedRow() as MaintenanceRecord;
            if (selectedRow != null)
            {
                try
                {
                    using (var editForm = new AddOrEditMaintenanceForm(_maintenanceService, OperationType.Update, selectedRow.Id))
                    {
